-- SiteGPT Verified Resolution Agent - Complete Schema
...
CREATE TABLE IF NOT EXISTS audit_events (
  ...
  event_type TEXT NOT NULL CHECK (event_type IN (
    'ticket_created', 'resolution_generated', 'draft_copied',
    'marked_contained', 'policy_changed', 'integration_connected', 'integration_disconnected'
  )),
...
CREATE TABLE IF NOT EXISTS subscriptions (
  ...
  status TEXT NOT NULL DEFAULT 'inactive' CHECK (status IN (
    'active', 'canceled', 'incomplete', 'incomplete_expired', 'past_due', 'trialing', 'unpaid', 'inactive'
  )),
  price_id TEXT,
